                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <h5>Users Tables</h5>
                            ...
                            while($row = $result->fetch_assoc()) {?>
                                ...
                                <td class="center"> 
                                    <a href="edit.php?edit_id=<?php echo $row['id'];?>" class="btn btn-warning">Edit </a>
                                    <a href="delete_user.php?delete_id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger"> Delete</a>
                                </td>
                                </tr>
                            <?php } ?>
                            </tbody>
